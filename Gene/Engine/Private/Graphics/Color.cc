...
Color::Color(float r, float g, float b, float a)
{
	...
	int rr = static_cast<int>(MathFunctions::Clamp(r, 0.0f, 1.0f)) * 255;
	int gg = static_cast<int>(MathFunctions::Clamp(g, 0.0f, 1.0f)) * 255;
	int bb = static_cast<int>(MathFunctions::Clamp(b, 0.0f, 1.0f)) * 255;
	int aa = static_cast<int>(MathFunctions::Clamp(a, 0.0f, 1.0f)) * 255;
